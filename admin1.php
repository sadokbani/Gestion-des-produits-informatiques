    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          <input type="text" name="newnom" class="form-control" placeholder="nom de produit" required="">
        </div>
        <div class="form-group">
          <input type="text" name="newprix" class="form-control" placeholder="prix" required="">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <textarea class="form-control" placeholder="description" name="descrip" required=""></textarea>
        </div>
      ...
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal">&times;</button>
          ...
          <?php 
                 ...
                 echo  '<form method="post" action="modifiee.php?nom='.$ligne['nom'].'" enctype="multipart/form-data" >
      <div class="modal-body">
        
        <div class="form-group">
          <input type="number" name="newprix" class="form-control" placeholder="new prix">
        </div>
        <div class="form-group">
          <input type="file" name="file" class="form-control" > 
        </div>
        <div class="form-group">
          <textarea class="form-control" placeholder="new description" name="descrip"></textarea>
        </div>
        <div class="modal-footer">
...
?>
 ...
 <?php 
              ...
              <div style="border:1px solid rgba(0,0,0,.125);border-radius:3px;height:400px;">
                ...
                <div class="card-body">
                  <h4 class="card-title">
                    <center><a href="#">'.$ligne['nom'].'</a></center>
                  </h4>
                  <center><h5>'.$ligne['prix'].'DT</h5></center>
                  <p class="card-text">'.$ligne['description'].'</p>
                  <center><a style="color:white;" class="btn btn-primary" data-toggle="modal" data-target="#update" >Modifier</a>
                  <a style="color:white;" class="btn btn-primary" href="deleteart.php?nom='.$ligne['nom'].'">Supprimer</a></center>
                </div>
