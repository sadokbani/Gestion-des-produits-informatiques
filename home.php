    ...
    <div class="modal-content">
      ...
      <form method="post" action="ajoutermsg.php" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="form-group">
            <input type="Email" name="msgeamil" class="form-control" placeholder="Email" required="" >
          </div>
          <div class="form-group">
...
Num One sur le marché du Smartphone en Tunisie.</p>
          ...
          <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
               <div class="carousel-item active">
                <img class="d-block img-fluid" src="y/4.jpg" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="y/2.jpg" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="y/3.jpg" alt="Third slide">
              </div>
            </div>
 ...
 <?php 
                  ...
                  $query = "SELECT * FROM produit  limit 9";
